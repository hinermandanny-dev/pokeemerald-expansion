...
#define GRASS_STARTER (IS_FRLG ? SPECIES_BULBASAUR  : SPECIES_WHISMUR)
#define FIRE_STARTER  (IS_FRLG ? SPECIES_CHARMANDER : SPECIES_LILLIPUP)
#define WATER_STARTER (IS_FRLG ? SPECIES_SQUIRTLE   : SPECIES_GALARIAN_ZIGZAGOON)
